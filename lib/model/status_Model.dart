...
class StatusModel {
  ...
  @override
  String toString() {
    return 'StatusModel(uid: $uid, username: $username,isSeen: $isSeen, phoneNumber: $phoneNumber, photoUrl: $photoUrl, texts: $texts, createdAt: $createdAt, profileImage: $profileImage, statusId: $statusId, whitelist: $whitelist, lastStatus: $lastStatus, seenBy: $seenBy)';
  }
