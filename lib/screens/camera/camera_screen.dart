...
class CameraHome extends StatefulWidget {
  ...
  CameraHome({super.key, required this.panelController});
...
class _CameraHomeState extends State<CameraHome> {
                  ...
                  child: OverflowBox(
                    ...
                    child: FittedBox(
                      ...
                      child: Container(
                        ...
                        height: constraints.maxWidth / aspectRatio - 150,
                    ...
                    return InkWell(
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => EditImageScreen(
                            id: 'item-$i',
                            resource: snapshot.data![i].assetEntity,
                          ),
                        ),
                      ),
                      child: Container(
  ...
  // Future<String> _saveImageToGallery(XFile image) async {
  //   // Add to the gallery
  //   var sstatus = await Permission.accessMediaLocation.request();
  //   if (sstatus.isGranted) {
  ...
  //     //   await customDirectory.create(recursive: true);
  //     // }
  //     // final imagePath = '${customDirectory.path}/${image.name}';
  //     // log('image path 0000000---- $imagePath: ');
  //
  ...
  //
  //     final success = await ImageGallerySaver.saveFile(image.path);
  //
  //     if (success["isSuccess"] == true) {
  //       log('Saved to gallery $success: ');
  //       return success["filePath"];
  //     } else {
  //       log('failed to Save image to gallery $success: ');
  //       return '';
  //     }
  //   } else {
  //     log('save gallery permissoins not granted');
  //     requestPermission();
  //     return '';
  //   }
  // }
...
//
// class FadeInThumbnail extends StatelessWidget {
//   FadeInThumbnail({
//     super.key,
