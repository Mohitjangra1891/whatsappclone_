...
import '../../widgets/setting_item_header.dart';
...
class _NotificationsSettingsScreenState extends State<NotificationsSettingsScreen> {
  NotificationToneOptions defaultNotificationTone = NotificationToneOptions.defaultNotificationSound;
  ...
  NotificationToneOptions defaultGroupNotificationTone = NotificationToneOptions.defaultNotificationSound;
  ...
  RingtoneOptions defaultCallsRingtone = RingtoneOptions.defaultRingtone;
  VibrateOptions defaultCallsVibrate = VibrateOptions.off;

  late Future<bool> _conversationTones;
  late Future<NotificationToneOptions> _notificationTone;
  NotificationToneOptions defaultNotification_tone = NotificationToneOptions.defaultNotificationSound;
  NotificationToneOptions default_group_Notification_tone = NotificationToneOptions.defaultNotificationSound;

  late Future<VibrateOptions> _vibrate;
  late Future<PopupNotificationOptions> _popupNotification;
  late Future<LightOptions> _light;
  late Future<bool> _useHighPriorityNotifications;

  late Future<NotificationToneOptions> _groupNotificationTone;
  late Future<VibrateOptions> _groupVibrate;
  late Future<PopupNotificationOptions> _groupPopupNotification;
  late Future<LightOptions> _groupLight;
  late Future<bool> _groupUseHighPriorityNotifications;

  late Future<RingtoneOptions> _callsRingtone;
  RingtoneOptions default_ringtone = RingtoneOptions.defaultRingtone;

  late Future<VibrateOptions> _callsVibrate;
  ...
  void initState() {
    ...
    _notificationTone = _prefs.then((SharedPreferences prefs) {
      return (prefs.getInt(SharedPreferencesHelpers.notificationTone) != null
          ? notificationToneOptionsList[prefs.getInt(SharedPreferencesHelpers.notificationTone)!]
    ...
    _popupNotification = _prefs.then((SharedPreferences prefs) {
      return (prefs.getInt(SharedPreferencesHelpers.popupNotification) != null
          ? popupNotificationOptionsList[prefs.getInt(SharedPreferencesHelpers.popupNotification)!]
    ...
    _useHighPriorityNotifications = _prefs.then((SharedPreferences prefs) {
      return (prefs.getBool(SharedPreferencesHelpers.useHighPriorityNotifications) ??
          SharedPreferencesHelpers.defaultUseHighPriorityNotifications);
    });

    _groupNotificationTone = _prefs.then((SharedPreferences prefs) {
      return (prefs.getInt(SharedPreferencesHelpers.groupNotificationTone) != null
          ? notificationToneOptionsList[prefs.getInt(SharedPreferencesHelpers.groupNotificationTone)!]
    ...
    _groupVibrate = _prefs.then((SharedPreferences prefs) {
      return (prefs.getInt(SharedPreferencesHelpers.groupVibrate) != null
          ? vibrateOptionsList[prefs.getInt(SharedPreferencesHelpers.groupVibrate)!]
          : defaultGroupVibrate);
    });
    _groupPopupNotification = _prefs.then((SharedPreferences prefs) {
      return (prefs.getInt(SharedPreferencesHelpers.groupPopupNotification) != null
          ? popupNotificationOptionsList[prefs.getInt(SharedPreferencesHelpers.groupPopupNotification)!]
    ...
    _groupUseHighPriorityNotifications = _prefs.then((SharedPreferences prefs) {
      return (prefs.getBool(SharedPreferencesHelpers.groupUseHighPriorityNotifications) ??
    ...
    _callsRingtone = _prefs.then((SharedPreferences prefs) {
      return (prefs.getInt(SharedPreferencesHelpers.callsRingtone) != null
          ? ringtoneOptionsList[prefs.getInt(SharedPreferencesHelpers.callsRingtone)!]
    ...
    _callsVibrate = _prefs.then((SharedPreferences prefs) {
      return (prefs.getInt(SharedPreferencesHelpers.callsVibrate) != null
          ? vibrateOptionsList[prefs.getInt(SharedPreferencesHelpers.callsVibrate)!]
          : defaultCallsVibrate);
    });
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          _buildFutureSettingItem(context, 'Notification tone', notificationToneOptionsList, _notificationTone,
              _getNotificationToneText, true, (NotificationToneOptions value) {
            _setNotificationTone(value.index);
          }),
          _buildFutureSettingItem(context, 'Vibrate', vibrateOptionsList, _vibrate, _getVibrateText, false,
              (VibrateOptions value) {
            _setVibrate(value.index);
          }),
          _buildFutureSettingItem(context, 'Popup notification', popupNotificationOptionsList, _popupNotification,
              _getPopupNotificationText, false, (PopupNotificationOptions value) {
            _setPopupNotification(value.index);
          }),
          _buildFutureSettingItem(context, 'Light', lightOptionsList, _light, _getLightText, false,
              (LightOptions value) {
          ...
          _buildFutureSettingItem(context, 'Notification tone', notificationToneOptionsList, _groupNotificationTone,
              _getNotificationToneText, true, (NotificationToneOptions value) {
            _setGroupNotificationTone(value.index);
          }),
          _buildFutureSettingItem(context, 'Vibrate', vibrateOptionsList, _groupVibrate, _getVibrateText, false,
              (VibrateOptions value) {
            _setGroupVibrate(value.index);
          }),
          _buildFutureSettingItem(context, 'Popup notification', popupNotificationOptionsList, _groupPopupNotification,
              _getPopupNotificationText, false, (PopupNotificationOptions value) {
            _setGroupPopupNotification(value.index);
          }),
          _buildFutureSettingItem(context, 'Light', lightOptionsList, _groupLight, _getLightText, false,
              (LightOptions value) {
          ...
          FutureBuilder(
            ...
            builder: (context, snapshot) {
              var onChanged;
              bool groupUseHighPriorityNotifications =
                  SharedPreferencesHelpers.defaultGroupUseHighPriorityNotifications;
              switch (snapshot.connectionState) {
                case ConnectionState.none:
                case ConnectionState.active:
          ...
          _buildFutureSettingItem(context, 'Ringtone', ringtoneOptionsList, _callsRingtone, _getRingtoneText, true,
              (RingtoneOptions value) {
            _setCallsRingtone(value.index);
          }),
          _buildFutureSettingItem(context, 'Vibrate', vibrateOptionsList, _callsVibrate, _getVibrateText, false,
              (VibrateOptions value) {
  ...
  _resetSettings() async {
    ...
    setState(() {
      _conversationTones = prefs
          .setBool(SharedPreferencesHelpers.conversationTones, SharedPreferencesHelpers.defaultConversationTones)
          .then((bool success) {
        return SharedPreferencesHelpers.defaultConversationTones;
      });
      _notificationTone =
          prefs.setInt(SharedPreferencesHelpers.notificationTone, defaultNotification_tone.index).then((bool success) {
        return defaultNotification_tone;
      });
      _popupNotification =
          prefs.setInt(SharedPreferencesHelpers.popupNotification, defaultPopupNotification.index).then((bool success) {
      ...
      _groupNotificationTone = prefs
          .setInt(SharedPreferencesHelpers.groupNotificationTone, default_group_Notification_tone.index)
          .then((bool success) {
        return default_group_Notification_tone;
      });
      _groupVibrate =
          prefs.setInt(SharedPreferencesHelpers.groupVibrate, defaultGroupVibrate.index).then((bool success) {
        return defaultGroupVibrate;
      });
      _groupPopupNotification = prefs
          .setInt(SharedPreferencesHelpers.groupPopupNotification, defaultGroupPopupNotification.index)
          .then((bool success) {
      ...
      _callsRingtone =
          prefs.setInt(SharedPreferencesHelpers.callsRingtone, default_ringtone.index).then((bool success) {
        return default_ringtone;
      });
      _callsVibrate =
          prefs.setInt(SharedPreferencesHelpers.callsVibrate, defaultCallsVibrate.index).then((bool success) {
  ...
  _setUseHighPriorityNotifications(bool value) async {
    ...
    setState(() {
      _useHighPriorityNotifications =
          prefs.setBool(SharedPreferencesHelpers.useHighPriorityNotifications, value).then((bool success) {
        return value;
      });
    });
  }
  ...
  _setGroupPopupNotification(int value) async {
    ...
    setState(() {
      _groupPopupNotification =
          prefs.setInt(SharedPreferencesHelpers.groupPopupNotification, value).then((bool success) {
        return popupNotificationOptionsList[value];
      });
    });
  }
  ...
  _setGroupUseHighPriorityNotifications(bool value) async {
    ...
    setState(() {
      _groupUseHighPriorityNotifications =
          prefs.setBool(SharedPreferencesHelpers.groupUseHighPriorityNotifications, value).then((bool success) {
        return value;
      });
    });
  }
