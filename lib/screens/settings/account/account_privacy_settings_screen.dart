  ...
  void initState() {
    ...
    _profilePhoto = _prefs.then((SharedPreferences prefs) {
      return (prefs.getInt(SharedPreferencesHelpers.profilePhoto) != null
          ? privacyOptionList[prefs.getInt(SharedPreferencesHelpers.profilePhoto)!]
          : defaultProfilePhoto);
    });
            ...
            if (snapshot.hasError) {
              ...
              onTap = () {
                DialogHelpers.showRadioDialog(
                    privacyOptionList, title, getText, context, snapshot.data, false, onChanged);
              };
            }
        }
        return SettingItem(
